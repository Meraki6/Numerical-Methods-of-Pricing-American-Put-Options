function price = BinomialTreeForward(S0, K, r, T, sigma, div, N)
% Binomial Tree Model of forward with continuous dividend
dt = T / N;
u = exp((r - div) * dt + sigma * sqrt(dt));
d = exp((r - div) * dt - sigma * sqrt(dt));
